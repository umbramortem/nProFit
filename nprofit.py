...
print('#-------------------------------nProFit v.1.0-----------------------------------')
print('#------------------------------n-Profile Fitting tool---------------------------')
print('#When using this code in your work, please properly refer to Cuevas-Otahola et al. 2022')
print('#Any comments or suggestions are welcome, please write an e-mail to b.cuevas.otahola@gmail.com')
print('#-------------------------------------------------------------------------------')
...
for k in filters:
	...
	ds9_dic[k]=ds9_name[filters==k][0]
...
if ('1' in input_file[24]) or ('2' in input_file[24]):
...
if 'yes' in input_file[25]:
        ...
        if os.path.exists('plots_profiles')==False:
	        os.system('mkdir plots_profiles')
	plots_dir=os.path.join(cur_dir,'plots_profiles')
	ds9_path=input_file[26]
	resu.mosaics(filters,ds9_dic,ds9_path,plots_dir,data_dir,names,scale)
	resu.plots(filters,plots_dir,mod_fit,data_dir,mag_zero,sky_dic,scale,arc_pix,fit_box)
